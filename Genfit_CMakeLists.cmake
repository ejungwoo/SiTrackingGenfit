...
#############################################################################
# install ROOT dictionary files (pcm and rootmap) - jungwoo
FILE(GLOB ROOT_DICT_FILES "${CMAKE_CURRENT_BINARY_DIR}/*.pcm" "${CMAKE_CURRENT_BINARY_DIR}/*.rootmap")
INSTALL(FILES ${ROOT_DICT_FILES} DESTINATION ${LIBRARY_OUTPUT_DIRECTORY})
SET(CMAKE_LIBRARY_OUTPUT_DIRECTORY ${CMAKE_BINARY_DIR}/lib)
FILE(MAKE_DIRECTORY ${CMAKE_LIBRARY_OUTPUT_DIRECTORY})  # ensure build/lib/ exists
FOREACH(dict_file ${ROOT_DICT_FILES})
    GET_FILENAME_COMPONENT(dict_name ${dict_file} NAME)
    CONFIGURE_FILE(${dict_file} ${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${dict_name} COPYONLY)
ENDFOREACH()
#############################################################################
